...
{
    public class ControllerTemplateModel : TemplateModel
    {
        ...
        public ControllerTemplateModel(TemplateModelContext context) : base(context.TableMetadata)
        {
            var targetNamespace = context.ApplicationOptions.ControllerGeneration.Namespace;
            var tableMetadata = context.TableMetadata;
